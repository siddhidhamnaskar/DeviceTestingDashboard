...
import MqttMacMappingTable from './components/MqttMacMappingTable';
import CityClientSiteTable from './components/CityClientSiteTable';
...
export default function KwikpayBoards() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'MqttDevices':
        return < MqttMacMappingTable />;
      case 'mqtt-mac-mapping':
        return <MqttMacMappingTable />;
      case 'mqtt':
      ...
      case 'mobivend-txns':
        return <MobiVendTxnsTable />;
      case 'mobivend-vendings':
        return <MobivendVendingsTable />;
      case 'mobivend-devices':
        return <MobivendDeviceTable />;
      case 'mobivend-qrcodes':
        return <MobivendQrCodesTable />;
      case 'city-client-sites':
        return <CityClientSiteTable />;
